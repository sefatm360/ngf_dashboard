...
const CustomerInvoiceRTO = ({ orderDetails }) => {
  const {
    order_date,
    customer_name,
    customer_phone,
                ...
                <table className='invoice-table'>
                    ...
                    <tr>
                      ...
                      <td className='queen-info'>
                        <div>
                          <p className='amount'>
                            <span>Subtotal:</span>{' '}
                            <small>{reducer?.netPrice}tk</small>
                          </p>
                          <p className='amount'>
                            <span>Delivery Charge:</span>
                            <small>{delivery_charge}tk</small>
                          </p>
                          <hr />
                          <p className='amount'>
                            <span>Total:</span>
                            <span>
                              {reducer.netPrice + Number(delivery_charge)}tk
                            </span>
                          </p>
                        </div>
                      </td>
                  ...
                  <tbody className='table_data'>
                    {order_details.map((order) => {
                      const { product_id, quantity, product_name, price } =
                        order;
                      return (
                        <tr key={product_id}>
...
export default CustomerInvoiceRTO;
